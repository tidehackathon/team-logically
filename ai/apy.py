...
async def solution(data:dict):
    ...
    df_tweets_with_articles = get_tweets_with_articles(filename_extraction, output_path) # pd.read_csv("tweets_with_articles.csv") #
    ...
    evidence_filtered_df, filename_evidence = generate_evidence_filtered_hackaton_dataset(filename_er, "sentence", 5, False)
